...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/SimonsGame.git
   ```
...
**Game Start**
![Amazon Clone Screenshot 1](https://raw.githubusercontent.com/ronik-bajakke/SimonGame/main/photo1.png)  
**Game Over**
